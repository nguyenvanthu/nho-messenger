...
@ChatCommandProcessor(command = { ChannelCommand.UPDATE_WAIT_TIME })
public class UpdateWaitTimeOfUserProcessor extends ChatAbstractProcessor {
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		this.getChatManager().updateWaitTimeOfUser(userName);

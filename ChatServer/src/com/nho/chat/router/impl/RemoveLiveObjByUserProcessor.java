...
@ChatCommandProcessor(command = { ChannelCommand.REMOVE_OBJ_BY_USER })
public class RemoveLiveObjByUserProcessor extends ChatAbstractProcessor {
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		this.getChatManager().removeBlockedObjOfUser(userName);

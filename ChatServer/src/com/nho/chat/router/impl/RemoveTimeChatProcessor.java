...
@ChatCommandProcessor(command = { ChannelCommand.REMOVE_TIME })
public class RemoveTimeChatProcessor extends ChatAbstractProcessor {
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		this.getChatManager().removeTimeChatOfUserWithBot(userName);

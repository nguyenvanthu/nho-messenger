...
@ChatCommandProcessor(command = { ChannelCommand.RESET_WAIT_TIME })
public class ResetWaitTimeOfUserProcessor extends ChatAbstractProcessor {
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		this.getChatManager().resetWaitTimeOfUser(userName);

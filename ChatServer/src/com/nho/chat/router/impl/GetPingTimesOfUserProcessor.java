...
@ChatCommandProcessor(command = { ChannelCommand.GET_PING_TIMES })
public class GetPingTimesOfUserProcessor extends ChatAbstractProcessor {
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		int pingTimes = this.getChatManager().getPingTimesOfUser(channelId, userName);

...
@ChatCommandProcessor(command = { ChannelCommand.REMOVE_USER_CHANNEL})
public class RemoveUserProcessor extends ChatAbstractProcessor{
	...
	public PuElement execute(PuObjectRO request) throws ChatException {
		...
		this.getChannelManager().removeUserInChannel(senderUser);

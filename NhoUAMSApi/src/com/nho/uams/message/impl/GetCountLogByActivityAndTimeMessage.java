...
public class GetCountLogByActivityAndTimeMessage extends UAMSAbstractMessage {
	private static final long serialVersionUID = 1L;
	{
		this.setType(UAMSMessageType.GET_COUNT_BY_ACTIVITY_TIME);
	}
	...
	public static GetCountLogByActivityAndTimeMessage fromPuObject(PuObject data) {
		GetCountLogByActivityAndTimeMessage message = new GetCountLogByActivityAndTimeMessage();
